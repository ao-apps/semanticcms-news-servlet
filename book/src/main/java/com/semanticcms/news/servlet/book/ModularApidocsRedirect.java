...
package com.semanticcms.news.servlet.book;
 ...
 */
@WebServlet("/news/servlet/apidocs/com/*")
public class ModularApidocsRedirect extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    HttpServletUtil.sendRedirect(
        ...
        "/news/servlet/apidocs/com.semanticcms.news.servlet/com" + Objects.toString(req.getPathInfo(), ""),
